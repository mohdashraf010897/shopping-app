...
const FeaturedCard: React.FC<FeaturedCardProps> = ({ imageUrl, title }) => {
  return (
    <figure className="flex flex-col items-center justify-center border border-gray-300 rounded-lg p-4 transition-all duration-300 ease-in-out relative bg-white w-[202px] h-[217px] hover:border-green-500 hover:shadow-md cursor-pointer hover:!text-green-700">
