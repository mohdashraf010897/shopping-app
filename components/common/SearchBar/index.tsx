  ...
  return (
    ...
    >
      <input
        ...
        className="border border-gray-300 rounded-lg shadow-sm p-3 flex-grow transition ease-in-out duration-300 hover:bg-gray-200 focus:bg-white active:bg-gray-300"
      />
